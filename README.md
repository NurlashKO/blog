...
|--------------|-------------|
[![vpn CI](https://github.com/NurlashKO/blog/actions/workflows/vpn-ci.yml/badge.svg)](https://github.com/NurlashKO/blog/actions/workflows/vpn-ci.yml)|OpenVPN server to allow clients change their "network geolocation"
